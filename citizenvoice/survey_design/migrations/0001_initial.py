...
import survey_design.models.survey
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expire_date', models.DateField(blank=True, default=survey_design.models.survey.in_duration_day, verbose_name='Expiration date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responses', to='survey_design.survey', verbose_name='Survey')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='questions', to='survey_design.category', verbose_name='Category')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='survey_design.survey', verbose_name='Survey')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='category',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='survey_design.survey', verbose_name='Survey'),
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='survey_design.question', verbose_name='Question')),
                ('response', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='survey_design.response', verbose_name='Response')),
            ],
        ),
    ]
